...
"""
    This script convert kotlin-server swagger autogenerated
     model into a proper format.
    ...
    You can provide the path in which directory is your model files or
    put your python script in the same directory with model files.
"""
...
# 			elif "val @baseType" in line or "val @schemaLocation" in line or "val @type" in line or "val @referredType" in line:
				...
				print(line, end='')
			elif 'LocalDateTime' in line or 'ZonedDateTime' in line or 'Instant' in line :
				# it can be LocalDateTime || ZonedDateTime || Instant || another date type
				line = line.replace('LocalDateTime', 'OffsetDateTime')
				print(line, end='')
			else:
